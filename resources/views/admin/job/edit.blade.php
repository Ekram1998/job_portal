                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class=" rounded-3 p-3 mb-4">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.jobs-list') }}">Jobs</a></li>
                            ...
                            <div class="card-body card-form p-4">
                                        ...
                                        <select name="job_type_id" class="form-select">
                                            ...
                                            @if ($jobType->isNotEmpty())
                                                @foreach ($jobType as $jobs)
                                                    <option {{ $job->job_type_id == $jobs->id ? 'selected' : '' }}
                                                        value="{{ $jobs->id }}">{{ $jobs->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <input type="text" placeholder="{{ $job->salary }}" id="salary"
                                    ...
                                    <div class="row">
                                        <div class="mb-4 col-md-6">
                                            <div class="form-check">
                                                <input {{($job->isFeature ==1) ? 'checked' : ''}} type="checkbox" class="form-check-input" name="isFeature" id="isFeature" value="1">
                                                <label class="form-check-label" for="isFeature">Featured</label>
                                            </div>
                                        </div>
                                        <div class="mb-4 col-md-6">
                                            <div class="form-check-inline">
                                                <input {{($job->status ==1) ? 'checked' : ''}} type="radio" class="form-check-input" value="1"
                                                    id="status-active" name="status">
                                                <label for="" class="form-check-label">Active</label>
                                            </div>
                                            <div class="form-check-inline">
                                                <input {{($job->status ==0) ? 'checked' : ''}} type="radio" class="form-check-input" value="0"
                                                    id="status-block" name="status">
                                                <label for="" class="form-check-label">Block</label>
                                            </div>
                                        </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="experience" id="" class="form-select">
                                        ...
                                        <option value="0" {{ $job->experience == 0 ? 'selected' : '' }}>Fresher
                                        </option>
                                        <option value="1" {{ $job->experience == 1 ? 'selected' : '' }}>1 Years
                                        </option>
                                        ...
                                        <option value="11" {{ $job->experience == 11 ? 'selected' : '' }}>10+ Years
                                        </option>
                                    </select>
